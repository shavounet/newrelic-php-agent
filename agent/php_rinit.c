...
int nr_php_sapi_activate(void) {
  ...
  nrl_verbosedebug(NRL_INIT,
                   ...
                   NRPRG(rinit_active), NRPRG(worker_request_active),
                   NRPRG(txn));
  ...
  NRPRG(worker_request_active) = true;
...
int nr_php_sapi_deactivate(void) {
   ...
   */
  if (!NRPRG(worker_request_active)) {
    nrl_verbosedebug(NRL_INIT,
  ...
  NRPRG(worker_request_active) = false;
